...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/agecalc
   cd agecalc
   ```
...
```sh
https://github.com/flex-development/agecalc/compare/main...$branch
```
...
[qa]: https://github.com/flex-development/agecalc/discussions/new?category=q-a
